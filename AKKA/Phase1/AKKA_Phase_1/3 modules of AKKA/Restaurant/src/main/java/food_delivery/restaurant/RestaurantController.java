...
public class RestaurantController {
    ...
    @ResponseBody public synchronized ResponseEntity acceptOrder(@RequestBody RestaurantOrderModel restOrder) {
    ...
    @ResponseBody public synchronized ResponseEntity refillItem(@RequestBody RestaurantOrderModel restOrder) {
