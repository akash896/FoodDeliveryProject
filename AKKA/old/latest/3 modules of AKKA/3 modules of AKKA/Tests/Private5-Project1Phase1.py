...
# 12. Check assigned to online agent 
# 13. make another agent Sing-In
# 14. Deliver the previous order
# 15. check agent status
# 16. check order status
# 17. deliver 2nd order
# 18. check respective agents and orders status
# 19. make agents sign-out
...
def test():
    ...
    if restaurant.refillItem(58, 101, 1, 10) : test_result = 'Fail'

    if restaurant.refillItem(59, 101, 2, 10) : test_result = 'Fail'

    if delivery.requestOrder(60, 302, 101, 2, 10, 'insufficient_fund') : test_result = 'Fail'

    if delivery.requestOrder(61, 302, 101, 2, 1, 'order_accepted') : test_result = 'Fail'
    
    if delivery.requestOrder(62, 303, 101, 1, 10, 'insufficient_fund') : test_result = 'Fail'

    if delivery.requestOrder(63, 303, 101, 1, 1, 'order_accepted') : test_result = 'Fail'

    if delivery.agentSignIn(64, 201) : test_result = 'Fail'

    if delivery.agentStatus(65, 201, 'unavailable') : test_result = 'Fail'

    if delivery.agentStatus(66, 10, 'signed-out') : test_result = 'Fail'

    if delivery.agentSignOut(67, 201) : test_result = 'Fail'

    if delivery.agentSignIn(68, 10) : test_result = 'Fail'

    if delivery.orderDelivered(69, 1006) : test_result = 'Fail'

    if delivery.orderStatus(70, 1007, 'assigned', 10) : test_result = 'Fail'

    if delivery.orderStatus(71, 1006, 'delivered', 201) : test_result = 'Fail'

    if delivery.agentSignOut(72, 201) : test_result = 'Fail'

    if delivery.agentStatus(73, 201, 'signed-out') : test_result = 'Fail'
    
    if delivery.agentStatus(74, 10, 'unavailable') : test_result = 'Fail'

    if delivery.orderDelivered(75, 1007) : test_result = 'Fail'
    
    if delivery.agentStatus(76, 10, 'available') : test_result = 'Fail'

    if delivery.agentSignOut(77, 10) : test_result = 'Fail'

    if delivery.agentStatus(78, 10, 'signed-out') : test_result = 'Fail'
