...
# Check if consistency is preserved in deduct Balance
...
def t1(result):  # First concurrent request
    # Customer 301 is deducted with 100 amount
    http_response = requests.post(
        "http://localhost:8082/deductBalance", json={"custId": 301, "amount": 100})
