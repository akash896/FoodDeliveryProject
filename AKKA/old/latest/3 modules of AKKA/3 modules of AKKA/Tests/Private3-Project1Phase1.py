...
def test():
    ...
    # if restaurant.refillItem(101, 1, 10) : test_result = 'Fail'

    if restaurant.refillItem(59, 101, 2, 10) : test_result = 'Fail'
    # if restaurant.refillItem(101, 2, 10) : test_result = 'Fail'
    ...
    if delivery.orderStatus(67, 1006, 'assigned', 201) : test_result = 'Fail'

    if delivery.orderStatus(68, 1007, 'unassigned') : test_result = 'Fail'
    
    if delivery.orderDelivered(69, 1006) : test_result = 'Fail'

    if delivery.agentStatus(70, 201, 'unavailable') : test_result = 'Fail'

    if delivery.orderDelivered(71, 1007) : test_result = 'Fail'

    if delivery.agentStatus(72, 201, 'available') : test_result = 'Fail'
    
    if delivery.agentSignOut(73, 201) : test_result = 'Fail'

    if delivery.agentStatus(74, 201, 'signed-out') : test_result = 'Fail'
...
if __name__ == "__main__":
    test_result = test()
    print(test_result)
    print("\033[1;32m SOMETIME 58th & 59th Method takes self function parameter leads to more parameter exception I'm new to python.")
